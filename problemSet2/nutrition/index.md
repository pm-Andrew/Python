...
In a file called `nutrition.py`, implement a program that prompts <strike>consumers</strike> users to input a fruit (case-insensitively) and then outputs the number of calories in one portion of that fruit, per the [FDA's poster for fruits](Nutrition-Information-for-Raw-Fruits---small-PDF-Poster.pdf), which is also [available as text](https://www.fda.gov/food/food-labeling-nutrition/raw-fruits-poster-text-version-accessible-version). Capitalization aside, assume that users will input fruits exactly as written in the poster (e.g., `strawberries`, not `strawberry`). Ignore any input that isn't a fruit.
...
<script async data-autoplay="1" data-cols="80" data-loop="1" data-rows="12" id="asciicast-l1yGc9HCul10e7VAp0nmLZNNY" src="https://asciinema.org/a/l1yGc9HCul10e7VAp0nmLZNNY.js"></script>
