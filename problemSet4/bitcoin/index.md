...
<!-- https://en.wikipedia.org/wiki/File:Bitcoin_logo.svg#/media/File:Bitcoin.svg -->
...
{% spoiler Hints %}
* Recall that the `sys` module comes with `argv`, per <https://docs.python.org/3/library/sys.html#sys.argv>.
* Note that the `requests` module comes with quite a few methods, per <https://requests.readthedocs.io/en/latest/>, among which are `get`, per <https://requests.readthedocs.io/en/latest/user/quickstart/#make-a-request>, and `json`, per <https://requests.readthedocs.io/en/latest/user/quickstart/#json-response-content>. You can install it with:
  ```
...
<script async data-autoplay="1" data-cols="80" data-loop="1" data-rows="12" id="asciicast-CDEoYDHQacpYQs6wZYbQlUNwy" src="https://asc
iinema.org/a/CDEoYDHQacpYQs6wZYbQlUNwy.js"></script>
