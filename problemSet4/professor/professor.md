...
{% video https://www.youtube.com/watch?v=ZuJwzH9BIgs %}
...
* Note that you can raise an exception like `ValueError` with code like:
  ...
  raise ValueError
  ```
* Note that the `random` module comes with quite a few functions, per <https://docs.python.org/3/library/random.html>.
{% endspoiler %}

## Demo

<script async data-autoplay="1" data-cols="80" data-loop="1" data-rows="12" id="asciicast-N7H7Mi3NLFhJefMKXHXIVPfhM" src="https://asc
iinema.org/a/N7H7Mi3NLFhJefMKXHXIVPfhM.js"></script>
