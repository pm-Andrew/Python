...
In a file called `fuel.py`, reimplement [Fuel Gauge](/psets/3/fuel/) from [Problem Set 3](/psets/3/), restructuring your code per the below, wherein:
...
* Note that you can check with `pytest` whether a function has raised an exception, per <https://docs.pytest.org/en/latest/how-to/assert.html#assertions-about-expected-exceptions>.
{% endspoiler %}
