...
* Note that the `Pillow` package comes with quite a few classes and methods, per <https://pypi.org/project/Pillow/>. You might find its [handbook](https://pillow.readthedocs.io/en/stable/handbook/) and [reference](https://pillow.readthedocs.io/en/stable/reference/) helpful to skim. You can install the package with:
  ```
  pip install Pillow
  ```
...
<script async data-autoplay="1" data-cols="80" data-loop="1" data-rows="12" id="asciicast-fpVXMVWsTHEaUIYmIbPWrWYSC" src="https://asciinema.org/a/fpVXMVWsTHEaUIYmIbPWrWYSC.js"></script>

{:#demos}
### Before

[![before](before1.jpg){:.img-thumbnail.w-25}](before1.jpg)
[![before](before2.jpg){:.img-thumbnail.w-25}](before2.jpg)
[![before](before3.jpg){:.img-thumbnail.w-25}](before3.jpg)

### After

![after](after1.jpg){:.img-thumbnail.w-25}
![after](after2.jpg){:.img-thumbnail.w-25}
![after](after3.jpg){:.img-thumbnail.w-25}
