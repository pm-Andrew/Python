...
* You might find <https://regex101.com/> or <https://regexr.com/> helpful for testing regular expressions (and visualizing matches).
* See <https://www.thefreedictionary.com/words-containing-um> for some words that contain "um".
{% endspoiler %}

## Demo

<script async data-autoplay="1" data-cols="80" data-loop="1" data-rows="12" id="asciicast-qRu2wGCLDDAI9wE8BXfJU0yRl" src="https://asciinema.org/a/qRu2wGCLDDAI9wE8BXfJU0yRl.js"></script>
