...
{% video https://www.youtube.com/watch?v=UvyHuse6buY %}
...
<script async data-autoplay="1" data-cols="80" data-loop="1" data-rows="12" id="asciicast-oZ7enGx9gddIQYIOQ2ynzBInO" src="https://asciinema.org/a/oZ7enGx9gddIQYIOQ2ynzBInO.js"></script>
...
* Run your program with `python seasons.py`. Ensure your program prompts you for a birthdate. Type a date one year ago from today, in the specified format, then press Enter. Your program should <strike>sing</strike> print `Five hundred twenty-five thousand, six hundred minutes`.
